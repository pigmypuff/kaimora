...
if(isset($_POST['update'])){
    ...
    //query;
    $sql = "UPDATE employee set  fname = '$FirstName', lname = '$LastName', name_with_initial = '$name', birthday ='$birthday', gender = '$gender', nic='$nic', contact='$contact', paddress ='$address', email='$email', post='$post'  where id = '$id'" ;
...
?>
   ...
   if(isset($_POST['submit'])){
    ...
    <div class="commonClass1" style="background-color:#7A7CA4; 
     color: white;">
    <header><h2 style="padding-left: 50px;">Update Employee </h2></header>  
    </div>
